...
export class ShellLists extends FourDModel {
	...
	fields:Array<any> = [
		{name:'RecordID', longname:'ShellLists.RecordID', type:'number', required:true, readonly:true, indexed:true, unique:true},
		...
		{name:'ListName', longname:'ShellLists.ListName', type:'string', required:true, length:50, indexed:true},
		{name:'ElementShortValue', longname:'ShellLists.ElementShortValue', type:'string', required:true, length:15, indexed:true},
		{name:'ElementLongValue', longname:'ShellLists.ElementLongValue', type:'string', length:50},
		{name:'ElementAltValue1', longname:'ShellLists.ElementAltValue1', type:'string', length:20},
		{name:'ElementAltValue2', longname:'ShellLists.ElementAltValue2', type:'string', length:255},

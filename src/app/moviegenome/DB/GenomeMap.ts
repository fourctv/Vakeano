...
export class GenomeMap extends FourDModel {
	...
	fields:Array<any> = [
		{name:'GeneId', longname:'GenomeMap.GeneId', type:'number', required:true, readonly:true, indexed:true, unique:true},
		{name:'Vector', longname:'GenomeMap.Vector', type:'string', required:true, length:10, indexed:true},
		...
		{name:'Cluster', longname:'GenomeMap.Cluster', type:'string', required:true, length:50, indexed:true},
		{name:'Coordinate', longname:'GenomeMap.Coordinate', type:'number', required:true},
		{name:'GeneName', longname:'GenomeMap.GeneName', type:'string', required:true, length:50, indexed:true, unique:true},
		{name:'GeneDescription', longname:'GenomeMap.GeneDescription', type:'string'},
		{name:'AvailableInUI', longname:'GenomeMap.AvailableInUI', type:'boolean', indexed:true},
		{name:'UIName', longname:'GenomeMap.UIName', type:'string', length:50, indexed:true, unique:true},
		{name:'UIDescription', longname:'GenomeMap.UIDescription', type:'string', length:255},
		{name:'UIGroup', longname:'GenomeMap.UIGroup', type:'string', length:255},
		{name:'AcceptedValuesList', longname:'GenomeMap.AcceptedValuesList', type:'string', required:true, length:255},
		{name:'DTPRequired', longname:'GenomeMap.DTPRequired', type:'boolean'},
		{name:'AppNarrativeType', longname:'GenomeMap.AppNarrativeType', type:'string', length:255},
		{name:'AppActingType', longname:'GenomeMap.AppActingType', type:'string', length:255}
	];

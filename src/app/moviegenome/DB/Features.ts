...
export class Features extends FourDModel {
	...
	fields:Array<any> = [
		{name:'FeatureId', longname:'Features.FeatureId', type:'number', required:true, readonly:true, indexed:true, unique:true},
		{name:'SeriesID', longname:'Features.SeriesID', type:'number', indexed:true},
		{name:'IMDBID', longname:'Features.IMDBID', type:'string', required:true, length:64, indexed:true, unique:true},
		{name:'IMDBTitle', longname:'Features.IMDBTitle', type:'string', required:true, length:100, indexed:true, unique:true},
		{name:'ProdYear', longname:'Features.ProdYear', type:'number', indexed:true},
		{name:'ProductionTitle', longname:'Features.ProductionTitle', type:'string', length:100, indexed:true},
		{name:'EpisodeNumber', longname:'Features.EpisodeNumber', type:'number'},
		{name:'ProdCompanyID', longname:'Features.ProdCompanyID', type:'number', indexed:true, relatesTo:'Companies.CompanyID'},
		{name:'ThemeVector', longname:'Features.ThemeVector', type:'string', length:255, indexed:true},
		{name:'NarrativeVector', longname:'Features.NarrativeVector', type:'string', length:255, indexed:true},
		{name:'ContentVector', longname:'Features.ContentVector', type:'string', length:255, indexed:true},
		{name:'ExecutionVector', longname:'Features.ExecutionVector', type:'string', length:255, indexed:true},
		{name:'StyleVector', longname:'Features.StyleVector', type:'string', length:255, indexed:true},
		...
		{name:'SeasonID', longname:'Features.SeasonID', type:'number', indexed:true, relatesTo:'Seasons.SeasonId'},
		{name:'DirectorsList', longname:'Features.DirectorsList', type:'string'},
		{name:'FeatureCast', longname:'Features.FeatureCast', type:'string', indexed:true},
		{name:'isStarCentered', longname:'Features.isStarCentered', type:'boolean'},
		{name:'CensorshipRating', longname:'Features.CensorshipRating', type:'string', length:10, indexed:true},
		{name:'CountryOfOrigin', longname:'Features.CountryOfOrigin', type:'string', length:255, indexed:true},
		{name:'OrigLanguages', longname:'Features.OrigLanguages', type:'string', length:255, indexed:true},
		{name:'PosterURL', longname:'Features.PosterURL', type:'string'},
		{name:'NarrativeType', longname:'Features.NarrativeType', type:'string', required:true, length:255, indexed:true},
		{name:'ActingType', longname:'Features.ActingType', type:'string', required:true, length:255, indexed:true},
		{name:'StarName', longname:'Features.StarName', type:'string', length:255},
		{name:'isControlFeature', longname:'Features.isControlFeature', type:'boolean'},
		{name:'JustWatchID', longname:'Features.JustWatchID', type:'string', length:255},
		{name:'TMDBID', longname:'Features.TMDBID', type:'string', length:255}
	];

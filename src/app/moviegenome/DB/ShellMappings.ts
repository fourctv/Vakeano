...
export class ShellMappings extends FourDModel {
	...
	fields:Array<any> = [
		{name:'RecordID', longname:'ShellMappings.RecordID', type:'number', required:true, readonly:true, indexed:true, unique:true},
		{name:'ExternalSystem', longname:'ShellMappings.ExternalSystem', type:'string', required:true, length:20, indexed:true},
		{name:'Reference', longname:'ShellMappings.Reference', type:'string', required:true, length:20, indexed:true},
		{name:'SubReference', longname:'ShellMappings.SubReference', type:'string', length:20, indexed:true},
		{name:'ExternalValue', longname:'ShellMappings.ExternalValue', type:'string', required:true, length:50, indexed:true},
		{name:'MappedValue', longname:'ShellMappings.MappedValue', type:'string', required:true, length:255, indexed:true},

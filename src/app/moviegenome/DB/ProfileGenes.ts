...
export class ProfileGenes extends FourDModel {
	...
	fields:Array<any> = [
		{name:'RecordID', longname:'ProfileGenes.RecordID', type:'number', required:true, readonly:true, indexed:true, unique:true},
		...
		{name:'ProfileID', longname:'ProfileGenes.ProfileID', type:'number', required:true, indexed:true, relatesTo:'TasteProfiles.ProfileID'},
		{name:'Frequency', longname:'ProfileGenes.Frequency', type:'number'},
		{name:'Weight', longname:'ProfileGenes.Weight', type:'number'},
		{name:'GeneID', longname:'ProfileGenes.GeneID', type:'number', required:true, indexed:true, relatesTo:'GenomeMap.GeneId'},
		{name:'WeightedRating', longname:'ProfileGenes.WeightedRating', type:'Number'},
		{name:'CoordinateValue', longname:'ProfileGenes.CoordinateValue', type:'string', length:1},
		{name:'ThemeGeneID', longname:'ProfileGenes.ThemeGeneID', type:'number'},
		{name:'CumValue', longname:'ProfileGenes.CumValue', type:'number'},
		{name:'ParentVector', longname:'ProfileGenes.ParentVector', type:'string', length:20, indexed:true}
	];

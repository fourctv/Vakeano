...
export class DescriptiveMetadata extends FourDModel {
	...
	fields:Array<any> = [
		{name:'RecordId', longname:'DescriptiveMetadata.RecordId', type:'number', required:true, readonly:true, indexed:true, unique:true},
		{name:'SeasonID', longname:'DescriptiveMetadata.SeasonID', type:'number', indexed:true, relatesTo:'Seasons.SeasonId'},
		{name:'SeriesID', longname:'DescriptiveMetadata.SeriesID', type:'number', indexed:true, relatesTo:'Series.SeriesId'},
		{name:'Target', longname:'DescriptiveMetadata.Target', type:'string', required:true, length:20, indexed:true},
		{name:'AbbrTitle', longname:'DescriptiveMetadata.AbbrTitle', type:'string', length:100, indexed:true},
		{name:'ShortTitle', longname:'DescriptiveMetadata.ShortTitle', type:'string', length:100, indexed:true},
		{name:'LongTitle', longname:'DescriptiveMetadata.LongTitle', type:'string', length:100, indexed:true},
		{name:'MarketTitle', longname:'DescriptiveMetadata.MarketTitle', type:'string', length:100, indexed:true},
		{name:'Tagline', longname:'DescriptiveMetadata.Tagline', type:'string', length:255, indexed:true},
		{name:'ShortSynopsis', longname:'DescriptiveMetadata.ShortSynopsis', type:'string', indexed:true},
		{name:'LongSynopsis', longname:'DescriptiveMetadata.LongSynopsis', type:'string', indexed:true},
		{name:'Genres', longname:'DescriptiveMetadata.Genres', type:'string', length:100, indexed:true},
		...
		{name:'FeatureID', longname:'DescriptiveMetadata.FeatureID', type:'number', indexed:true, relatesTo:'Features.FeatureId'},
		{name:'MDLanguage', longname:'DescriptiveMetadata.MDLanguage', type:'string', required:true, length:3, indexed:true},
		{name:'MediumSynopsis', longname:'DescriptiveMetadata.MediumSynopsis', type:'string', indexed:true}
	];

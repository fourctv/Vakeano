...
export class Series extends FourDModel {
	...
	fields:Array<any> = [
		{name:'SeriesId', longname:'Series.SeriesId', type:'number', required:true, readonly:true, indexed:true, unique:true},
		...
		{name:'IMDBID', longname:'Series.IMDBID', type:'string', required:true, length:64, indexed:true, unique:true},
		{name:'IMDBTitle', longname:'Series.IMDBTitle', type:'string', required:true, length:100, indexed:true},
		{name:'ProdYear', longname:'Series.ProdYear', type:'number', indexed:true},
		{name:'ProductionTitle', longname:'Series.ProductionTitle', type:'string', length:100, indexed:true},
		{name:'ThemeVector', longname:'Series.ThemeVector', type:'string', length:255, indexed:true},
		{name:'NarrativeVector', longname:'Series.NarrativeVector', type:'string', length:255, indexed:true},
		{name:'ContentVector', longname:'Series.ContentVector', type:'string', length:255, indexed:true},
		{name:'ExecutionVector', longname:'Series.ExecutionVector', type:'string', length:255, indexed:true},
		{name:'StyleVector', longname:'Series.StyleVector', type:'string', length:255, indexed:true},
		{name:'NarrativeType', longname:'Series.NarrativeType', type:'string', required:true, length:255},
		{name:'ActingType', longname:'Series.ActingType', type:'string', required:true, length:255}
	];

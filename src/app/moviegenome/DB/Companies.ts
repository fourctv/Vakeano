...
export class Companies extends FourDModel {
	...
	fields:Array<any> = [
		{name:'CompanyID', longname:'Companies.CompanyID', type:'number', required:true, readonly:true, indexed:true, unique:true},
		...
		{name:'ShortName', longname:'Companies.ShortName', type:'string', required:true, length:50, indexed:true},
		{name:'LongName', longname:'Companies.LongName', type:'string', length:255},
		{name:'CompanyRoles', longname:'Companies.CompanyRoles', type:'string', required:true, length:100, indexed:true}
	];

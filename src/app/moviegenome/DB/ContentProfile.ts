...
export class ContentProfile extends FourDModel {
	...
	fields:Array<any> = [
		{name:'RecordID', longname:'ContentProfile.RecordID', type:'number', required:true, readonly:true, indexed:true, unique:true},
		...
		{name:'FeatureID', longname:'ContentProfile.FeatureID', type:'number', indexed:true, relatesTo:'Features.FeatureId'},
		{name:'SeasonID', longname:'ContentProfile.SeasonID', type:'number', indexed:true, relatesTo:'Seasons.SeasonId'},
		{name:'SeriesID', longname:'ContentProfile.SeriesID', type:'number', indexed:true, relatesTo:'Series.SeriesId'},
		{name:'GeneID', longname:'ContentProfile.GeneID', type:'number', required:true, indexed:true, relatesTo:'GenomeMap.GeneId'},
		{name:'CuratorID', longname:'ContentProfile.CuratorID', type:'number', required:true, indexed:true, relatesTo:'_ShellUsers.ID'},
		{name:'CoordinateValue', longname:'ContentProfile.CoordinateValue', type:'string', length:1, indexed:true}
	];

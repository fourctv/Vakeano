    ...
    template: `
        <div class="formPanel">
            ...
            <div class="row" style="padding-left:10px;">
                <h4>
                    Select the Taste Profile to use for analyzing:
                    <span style="color:green;">{{
                        inputData.featureName
                    }}</span>
                </h4>
                <button
                    class="regularButton"
                    style="width:120px;margin-left:380px"
                    (click)="checkFeature()"
                >
                    Analyze
                </button>
            ...
            <div style="margin-bottom:15px;">
                <h3>Results:</h3>
                <textarea
                    style="width:950px;height:120px"
                    class="fieldEntry"
                    type="text"
                    [(ngModel)]="analyzeResponse"
                    disable
                ></textarea>
            </div>
            <div>
    ...
    public checkFeature() {
        ...
        if (this.theGrid && this.theGrid.currentRecord) {
            let body = {
                ...
                profileID: (<TasteProfilesEx>this.theGrid.currentRecord)
                    .ProfileID
            };
            this.fourD
                .call4DRESTMethod("MGRErestCheckFeature", body, {
                    responseType: "text"
                })
                .subscribe(
                    result => {

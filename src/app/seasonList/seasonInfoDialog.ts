...
export class SeasonInfoDialog extends RecordEditWindow
    ...
    @ViewChild(SeasonEpisodeList, { static: false }) private episodeList: SeasonEpisodeList;
    @ViewChild(Tabs, { static: false }) private tabList: Tabs;
    @ViewChild("episodeList", { static: false }) private episodeListTab: Tab;
    ...
    ngAfterViewInit() {
        this.dialog.setTitle(
            "Series Details: " +
                ...
                " - Season " +
                this.currentRecord.SeasonNumber
        );
        if (
            ...
            this.tmdb
                ...
                .then(recjw => {
                    if (this.tmdb.tmdbRecord) {
                        this.tmdb
                            .grabTMDBSeasonData(this.currentRecord)
